...
def solution(k, ranges):
    ...
    for start, end in ranges:
        if start == 0 and end == 0:
            ...
            answer.append(sum(width[start:(n+end)])) # n-end-1 이 n-end까지 구한 넓이임
...
if __name__ == "__main__":
    ...
    print(f"ranges:{ranges}, k:{k}, Answer:{solution(k, ranges)}, is_Correct:{solution(k, ranges) == [33.0,31.5,0.0,-1.0]}") # [33.0,31.5,0.0,-1.0]
    
    k = 3
    ranges = [[0,0], [1,-2], [3,-3]]
    print(f"ranges:{ranges}, k:{k}, Answer:{solution(k, ranges)}, is_Correct:{solution(k, ranges) == [47.0,36.0,12.0]}") # [47.0,36.0,12.0]